...
plugin_name = raw_input("lib name: ")
name_convertor = NameConvertor(plugin_name)
dest_path = os.path.join('../src/runtime', name_convertor.to_aa_bb_cc())
if os.path.exists(dest_path):
    raise '{0} is already exists!'.format(dest_path)

print('begin generate runtime template {0} in {1}'.format(plugin_name, dest_path))
